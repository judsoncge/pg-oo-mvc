...
class LoginModel extends Model{
	...
	public function login($CPF, $senha){
		...
		$resultado = mysqli_query($this->conexao, "SELECT a.ID, DS_FUNCAO, ID_SETOR, a.DS_NOME, DS_FOTO, b.DS_ABREVIACAO NOME_SETOR FROM tb_servidores a, tb_setores b WHERE a.ID_SETOR = b.ID AND DS_CPF = '$CPF' AND SENHA = '$senha'") or die(mysqli_error($this->conexao));
