...
ALTER TABLE tb_processos DROP FOREIGN KEY tb_processos_ibfk_1;
...
ALTER TABLE `tb_processos_sobrestados` DROP FOREIGN KEY `tb_processos_sobrestados_ibfk_1`; ALTER TABLE `tb_processos_sobrestados` ADD CONSTRAINT `tb_processos_sobrestados_ibfk_1` FOREIGN KEY (`ID_PROCESSO`) REFERENCES `tb_processos`(`ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `tb_historico_processos` CHANGE `DT_ACAO` `DT_ACAO` DATETIME NOT NULL;

ALTER TABLE `tb_historico_chamados` CHANGE `DT_ACAO` `DT_ACAO` DATETIME NOT NULL;