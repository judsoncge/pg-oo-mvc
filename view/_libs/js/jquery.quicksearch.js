 ...
 */
 ...
 //version from http://stackoverflow.com/questions/16757431/how-can-i-extend-jquery-quicksearch-so-it-can-search-words-with-accents
    ...
    $.fn.quicksearch = function (target, opt) {
        ...
        this.go = function () {
			...
			if (document.getElementById("qtde")) {
				document.getElementById("qtde").innerHTML = "Total: " + this.matchedResultsCount;            
			}
			return this;
        };
